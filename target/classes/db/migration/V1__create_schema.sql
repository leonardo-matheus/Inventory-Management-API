...
-- Usuario admin inicial (senha: admin123, terá que ser BCrypt na prática).
-- Para simplificar nos testes manuais, vamos trocar a senha programaticamente se quiser,
-- mas aqui deixamos um hash de admin123 (BCrypt).
INSERT INTO usuario (username, password, role, ativo)
VALUES ('admin', '$2a$10$QX4YHgf12e.sv5J3Nw1CeOVQj9Ca8Dq8.zQxFdOGw3Hg65D9C5t5K', 'ROLE_ADMIN', TRUE);
